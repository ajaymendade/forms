...
const CreateFormPage = () => {
  ...
  const handleSaveForm = async () => {
    try {
      console.log('FormData:', formData); // Log formData to inspect its structure
  
      // Send a POST request to the backend endpoint with the form data
  ...
  const handleAddComponent = (componentType) => {
    const newComponent = {
      type: componentType,
      title: '',
      question: `Enter your ${componentType} question here`, // Default question text
      answer: '',
